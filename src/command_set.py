...
class Kinds:
    ...
    SET_POWER_STATE = 0x05
    GET_AUTOMOTIVE_MODE = 0x06
    SET_AUTOMOTIVE_MODE = 0x07
    GET_LOWPOWER_ENABLE = 0x08
    SET_LOWPOWER_ENABLE = 0x09
    GET_STARTUP_TIMER = 0x0A
    SET_STARTUP_TIMER = 0x0B
    GET_SOFTOFF_TIMER = 0x0C
    SET_SOFTOFF_TIMER = 0x0D
    GET_HARDOFF_TIMER = 0x0E
    SET_HARDOFF_TIMER = 0x0F
